...
public class CallLLMService {
    ...
    /**
     * ID와 사용자 ID를 사용하여 특정 LLM 대화 기록을 조회합니다.
     * @param id 조회할 대화 기록의 ID.
     * @param userId 대화 기록을 소유한 사용자의 ID.
    ...
    /**
     * ID와 사용자 ID를 사용하여 특정 LLM 대화 기록을 삭제합니다.
     * @param id 삭제할 대화 기록의 ID.
     * @param userId 대화 기록을 소유한 사용자의 ID.
     * @throws IllegalStateException 지정된 ID와 사용자 ID의 대화 기록을 찾을 수 없는 경우.
     */
    @Transactional
    ...
    /**
     * 특정 사용자 ID에 해당하는 모든 LLM 대화 기록을 삭제합니다.
     * @param userId 모든 대화 기록을 삭제할 사용자의 ID.
     * @throws IllegalStateException 지정된 ID의 사용자를 찾을 수 없는 경우.
     */
    @Transactional
